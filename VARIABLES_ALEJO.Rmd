...
"P6040", "P8587", "P6435", "P5661s5", "P6240", "p8586"
...
```{r}
vivi_hijos <- merge(x = datos_vivienda, y = hijos_hogar, by = 'DIRECTORIO',all = TRUE)
...
Ahora la relación de la variable con la cantidad de hijos en el hogar
