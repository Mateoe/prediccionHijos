...
**NOTA:** Ahora la relación de la variable con la cantidad de hijos en el hogar no es sposible en tanto los directorios de la base de datos hijos_hogar difieren todos de los directorios de la base de datos datos_vivienda.
