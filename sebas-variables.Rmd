...
```{r}
href <- hijoscab
href$P6083[href$P6083==3] <- 2
ggplot(href, aes(x = factor(P6083), y = n)) + geom_boxplot(outlier.colour = "red", outlier.shape = 1)
```
no se considera?
...
ggplot(hijosxtelefonosxtic, aes(x = smartf, y = n)) + geom_point() + scale_x_continuous(breaks = seq(0,13,1))  + scale_y_continuous(breaks = seq(0,13,1))
```
...
ggplot(hijosxsdh, aes(x = P5000, y = n)) + geom_point()
```
```{r}
...
ggplot(hijosxsdh, aes(x = P5024, y = n)) + geom_point() + scale_x_continuous(breaks = seq(0,13,1))  + scale_y_continuous(breaks = seq(0,13,1))
```
```{r}
with(hijosxsdh[!is.na(hijosxsdh$P5024),],cor(n, P5024))
...
ggplot(hijosxsdh, aes(x = P5013S1, y = n)) + geom_point() 
```
```{r}
with(hijosxsdh[!is.na(hijosxsdh$P5013S1),],cor(n, P5013S1))
```
...
ggplot(hijosxsdh, aes(x = I_HOGAR, y = n)) + geom_point() 
```
```{r}
...
ggplot(hijosxsdh, aes(x = I_UGASTO, y = n)) + geom_point() 
```
```{r}
...
ggplot(hijosxsdh, aes(x = PERCAPITA, y = n)) + geom_point() 
```
```{r}
...
ggplot(hijosxsdh, aes(x = I_OU, y = n)) + geom_point() 
```
```{r}
...
ggplot(hijosxsdh, aes(x = CANT_PERSONAS_HOGAR , y = n)) + geom_point() + scale_x_continuous(breaks = seq(0,13,1))
```
```{r}
...
```{r}
plot(hijosxsdh[hijosxsdh$n==13,]$I_OU,hijosxsdh[hijosxsdh$n==13,]$n)
plot(hijosxsdh$I_OU,hijosxsdh$n)
plot(hijosxsdh[hijosxsdh$n==13,]$PERCAPITA,hijosxsdh[hijosxsdh$n==13,]$n)
plot(hijosxsdh$PERCAPITA,hijosxsdh$n)
plot(hijosxsdh[hijosxsdh$n==13,]$I_UGASTO,hijosxsdh[hijosxsdh$n==13,]$n)
plot(hijosxsdh$I_UGASTO,hijosxsdh$n)
plot(hijosxsdh[hijosxsdh$n==13,]$I_HOGAR,hijosxsdh[hijosxsdh$n==13,]$n)
plot(hijosxsdh$I_HOGAR,hijosxsdh$n)
#P5013S1 Cantidad de comidas
plot(hijosxsdh[hijosxsdh$n==13,]$P5013S1,hijosxsdh[hijosxsdh$n==13,]$n)
plot(hijosxsdh$P5013S1,hijosxsdh$n)
## P5000 cuartos
plot(hijosxsdh[hijosxsdh$n==13,]$P5000,hijosxsdh[hijosxsdh$n==13,]$n)
plot(hijosxsdh$P5000,hijosxsdh$n)
```
